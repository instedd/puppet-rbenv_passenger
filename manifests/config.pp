  ...
  case $::osfamily {
    'debian': {
      file { '/etc/apache2/mods-available/passenger.load':
        ...
        content => template('rbenv_passenger/passenger-load.erb'),
        owner   => '0',
        group   => '0',
        mode    => '0644',
      ...
      file { '/etc/apache2/mods-available/passenger.conf':
        ...
        content => template('rbenv_passenger/passenger-enabled.erb'),
        owner   => '0',
        group   => '0',
        mode    => '0644',
        notify  => Service['httpd'],
      ...
      file { '/etc/apache2/mods-enabled/passenger.load':
        ...
        group   => '0',
        mode    => '0777',
        require => [ File['/etc/apache2/mods-available/passenger.load'], Class['rbenv_passenger::compile'], ],
        notify  => Service['httpd'],
      }
    ...
    'redhat': {
      ...
      file { '/etc/httpd/conf.d/passenger.conf':
        ...
        content => template('rbenv_passenger/passenger-conf.erb'),
        owner   => '0',
        group   => '0',
        mode    => '0644',
        notify  => Service['httpd'],
